...
let kAMMessageCellNodeContentTopTextAttributes = [NSForegroundColorAttributeName: UIColor.lightGrayColor(),
    NSFontAttributeName: UIFont(name: "OpenSans-Light", size: 12)!] //текст имение пользотвателя
...
class MessageCellNode: ASCellNode {
    ...
    override func calculateSizeThatFits(constrainedSize: CGSize) -> CGSize {
        let pairs: [(ASDisplayNode?, CGFloat)] = [(topTextNode, 5), (contentTopTextNode, contentTopTextNodeXOffset), (contentNode, 5), (bottomTextNode, 5)]
    ...
    override func layout() {
        ...
        let pairs: [(ASDisplayNode?, CGFloat)] = [(topTextNode, topTextNodeXOffset), (contentTopTextNode, contentTopTextNodeXOffset), (contentNode, 10), (bottomTextNode, 0)]
