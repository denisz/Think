...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-Think/LGActionSheet.framework"
  install_framework "Pods-Think/LGAlertView.framework"
  install_framework "Pods-Think/LGDrawer.framework"
  install_framework "Pods-Think/LGFilterView.framework"
  install_framework "Pods-Think/LGHelper.framework"
  install_framework "Pods-Think/LGSideMenuController.framework"
  ...
  install_framework "Pods-Think/UIImage_AF_Additions.framework"
  install_framework "Pods-Think/VGParallaxHeader.framework"
