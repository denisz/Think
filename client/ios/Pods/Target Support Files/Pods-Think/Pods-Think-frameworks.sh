...
install_framework()
{
  local source="${BUILT_PRODUCTS_DIR}/Pods-Think/$1"
...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework 'LGActionSheet.framework'
  install_framework 'LGAlertView.framework'
  install_framework 'LGDrawer.framework'
  install_framework 'LGFilterView.framework'
  install_framework 'LGHelper.framework'
  install_framework 'LGSideMenuController.framework'
  install_framework 'LGViews.framework'
